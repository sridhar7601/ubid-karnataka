...
import { getRecordStats, uploadRecords, runLinkage, listUnifiedEntities, getDashboardOverview } from '../api';
import type { RecordStats, LinkageRunResult, DashboardOverview } from '../api';
...
export default function Dashboard() {
  ...
  const fetchStats = useCallback(async () => {
    try {
      ...
      // Fetch AI briefing in parallel; fail silently if backend stale
        ...
        <div className="rounded-xl bg-gradient-to-br from-indigo-50 to-white border-l-4 border-indigo-500 border-y border-r border-indigo-100 p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="ml-auto text-xs text-gray-500">
              {overview.unified_count} UBIDs · {overview.pending_review} in review
            </span>
          </div>
